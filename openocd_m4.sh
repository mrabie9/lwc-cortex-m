...
echo
openocd -f C:/WSD030/m7_board/m7_board/Board/board.cfg -f C:/WSD030/m7_board/m7_board/Board/stm32l4discovery.cfg -c "program $wdir/$elf_file verify reset exit"
